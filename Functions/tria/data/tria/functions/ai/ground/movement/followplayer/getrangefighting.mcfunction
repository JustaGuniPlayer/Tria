...
execute as @a[scores={ID=1..4}] at @s run scoreboard players set @e[tag=FollowPlayer,tag=AIFighting,distance=6..9] FPrange 2
execute as @a[scores={ID=1..4}] at @s run scoreboard players set @e[tag=FollowPlayer,tag=AIFighting,distance=..6] FPrange 1

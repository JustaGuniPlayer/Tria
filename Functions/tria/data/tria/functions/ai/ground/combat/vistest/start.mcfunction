...
execute as @e[tag=InitVisTest,scores={Team=-1,TargetID=0}] run scoreboard players operation @s Random = @e[tag=Random,scores={Random=1..2},limit=1,sort=random] Random

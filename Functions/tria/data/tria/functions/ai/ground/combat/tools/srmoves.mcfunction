...
execute as @e[scores={SRmoves=1..,Random=2}] at @s positioned ^0.6 ^ ^ if block ~ ~0.1 ~ #tria:cangothrough if block ~ ~1.1 ~ #tria:cangothrough unless block ~ ~-0.9 ~ #tria:cangothrough run tp @s ~ ~0.001 ~
...
execute as @e[scores={SRmoves=1..,Random=4}] at @s positioned ^-0.6 ^ ^ if block ~ ~0.1 ~ #tria:cangothrough if block ~ ~1.1 ~ #tria:cangothrough unless block ~ ~-0.9 ~ #tria:cangothrough run tp @s ~ ~0.001 ~

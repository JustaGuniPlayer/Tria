...
execute at @s as @e[tag=CanBeShot] if score @s ID = @e[tag=Source,limit=1] TargetID unless entity @s[scores={SpecialHitbox=1}] facing entity @s eyes run tp @e[tag=Source] ~0.001 ~ ~ ~ ~

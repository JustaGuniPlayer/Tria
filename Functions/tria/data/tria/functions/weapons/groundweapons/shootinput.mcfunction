...
# Shoots
execute as @a[tag=!LockWeapons,scores={ActiveSlot=0,UseCarrot=1..,InVehicle=0,1stWeapon=1..,1stReloading=0,1stCdShoot=0,1stAmoLoaded=1..}] run function tria:weapons/groundweapons/shooting/shoot1
execute as @a[tag=!LockWeapons,scores={ActiveSlot=1,UseCarrot=1..,InVehicle=0,2ndWeapon=1..,2ndReloading=0,2ndCdShoot=0,2ndAmoLoaded=1..}] run function tria:weapons/groundweapons/shooting/shoot2

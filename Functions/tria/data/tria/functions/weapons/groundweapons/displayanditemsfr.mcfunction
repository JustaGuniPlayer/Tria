...
execute as @a[scores={ActiveSlot=0,InVehicle=0,1stWeapon=1..,1stReloading=1..,ID=1..4},tag=!Lock1st] run title @s actionbar {"text":"Rechargement...","bold":"true"}
execute as @a[scores={ActiveSlot=0,InVehicle=0,1stWeapon=1..,1stReloading=1..,ID=1..4},tag=Lock1st] run title @s actionbar {"text":"Vous ne pouvez pas utiliser cette arme si vous etes au sol !","bold":"true"}
...
title @a[scores={ActiveSlot=1,InVehicle=0,2ndWeapon=1,2ndReloading=1..,ID=1..4}] actionbar {"text":"Rechargement...","bold":"true"}

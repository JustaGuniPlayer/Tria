...
# Slots 0 and 1
execute as @a[scores={ActiveSlot=0,InVehicle=0,1stWeapon=1..,1stReloading=0,ID=1..4},tag=!LockWeapons] run title @s actionbar {"text":"< ","extra":[{"score":{"objective":"1stAmoLoaded","name":"@s"},"bold":"true"},{"text":"/"},{"score":{"objective":"1stLoadCapacity","name":"@s"},"bold":"true"},{"text":" > : "},{"score":{"objective":"1stAmo","name":"@s"},"bold":"true"}]}
...
execute as @a[scores={ActiveSlot=1,InVehicle=0,2ndWeapon=1..,2ndReloading=0,ID=1..4},tag=!LockWeapons] run title @s actionbar {"text":"< ","extra":[{"score":{"objective":"2ndAmoLoaded","name":"@s"},"bold":"true"},{"text":"/"},{"score":{"objective":"2ndLoadCapacity","name":"@s"},"bold":"true"},{"text":" > : "},{"score":{"objective":"2ndAmo","name":"@s"},"bold":"true"}]}
...
# Slot 7
title @a[scores={ActiveSlot=7,InVehicle=0,ID=1..4},tag=LockWeapons] actionbar {"text":"Vous ne pouvez pas utiliser cette arme si vous etes au sol !","bold":"true"}

...
execute if entity @a[tag=!Spawn] run summon firework_rocket 1000 105 1000 {Tags:["CanBeAlive"],LifeTime:0,FireworksItem:{id:fireworks,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Colors:[I;16755200],FadeColors:[I;16777215]}]}}}}

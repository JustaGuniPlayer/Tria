# Slots 0 and 1
replaceitem entity @a[scores={HotbarState=1,1stWeapon=1}] hotbar.0 minecraft:carrot_on_a_stick{display:{Name:"FAMAS du Turfu"}} 1
...
# Slot 6
replaceitem entity @a[scores={HotbarState=1}] hotbar.6 minecraft:carrot_on_a_stick{display:{Name:"Ordre",Lore:["Click droit pour utiliser","Jetter pour changer d'ordre"]}} 1 

# Slot 7
replaceitem entity @a[scores={HotbarState=1,Grenades=0}] hotbar.7 minecraft:black_stained_glass_pane{display:{Name:"."}} 1
replaceitem entity @a[scores={HotbarState=1,Grenades=1..}] hotbar.7 minecraft:carrot_on_a_stick{display:{Name:"Vous allez vous eclater"}} 1

# Slot 8

# Slot OffHand
replaceitem entity @a[scores={HotbarState=1}] weapon.offhand air
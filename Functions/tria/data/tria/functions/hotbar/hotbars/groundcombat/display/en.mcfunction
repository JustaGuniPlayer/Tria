...
title @a[scores={1stWeapon=1..,1stReloading=1..,HotbarState=1},nbt={SelectedItemSlot:0},tag=!LockWeapons] actionbar {"text":"Reloading...","bold":"true"}
title @a[scores={1stWeapon=1..,HotbarState=1},nbt={SelectedItemSlot:0},tag=LockWeapons] actionbar {"text":"You can't use this while dead!","bold":"true"}
...
title @a[scores={2ndWeapon=1..,2ndReloading=1..,HotbarState=1},nbt={SelectedItemSlot:1},tag=!LockWeapons] actionbar {"text":"Reloading...","bold":"true"}
title @a[scores={2ndWeapon=1..,HotbarState=1},nbt={SelectedItemSlot:1},tag=LockWeapons] actionbar {"text":"You can't use this while dead!","bold":"true"}
...
title @a[scores={HotbarState=1,Order=1},nbt={SelectedItemSlot:6}] actionbar {"text":"Follow me","bold":"true"}
title @a[scores={HotbarState=1,Order=2},nbt={SelectedItemSlot:6}] actionbar {"text":"Go here","bold":"true"}

# Slot 7
title @a[scores={HotbarState=1},nbt={SelectedItemSlot:7},tag=LockWeapons] actionbar {"text":"You can't use this while dead!","bold":"true"}

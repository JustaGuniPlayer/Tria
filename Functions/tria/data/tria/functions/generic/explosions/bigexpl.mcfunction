...
#Degats
scoreboard players remove @e[scores={Health=1..},tag=!NoExplDamage,distance=..11] Health 40
scoreboard players remove @e[scores={Health=1..},tag=!NoExplDamage,distance=..9] Health 40
